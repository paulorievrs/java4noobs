<h1>Exercício 2</h1>
Acho muito válido com o que foi passado a possibilidade da construção desse exercício, a resposta mais coerente consta <a href="https://github.com/paulorievrs/java4noobs/blob/master/Extras/Resolucao-Exercicios/Exercicio2.java">aqui</a>, lembrando que cada um tem seu jeito de programar, portanto, o meu não representa que deve estar daquele jeito, é so um molde para correção e caso não consiga.
