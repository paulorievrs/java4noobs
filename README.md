...
5. Para ter acesso ao fork criado na sua máquina é necessário clonar o repositório. Que pode ser feito através do comando <git clone> e a URL do seu fork. No seu terminal você irá digitar: git clone <url_do_fork>
